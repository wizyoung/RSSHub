...
router.get('/twitter/media/:id/:routeParams?', require('./routes/twitter/media'));
...
// e-hentai
router.get('/ehentai/favorites/:favcat?/:order?/:page?', require('./routes/ehentai/favorites'));
router.get('/ehentai/search/:params?/:page?', require('./routes/ehentai/search'));
router.get('/ehentai/tag/:tag/:page?', require('./routes/ehentai/tag'));
